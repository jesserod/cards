 ...
 * 2013/02/09
 *
 * Returns an object with atributes "targets" and "hits" which are arrays
 * indicating which elements in "this" jquery collection overlap with elements
 * in the "obj" jquery collection.
 *
 */
(function($){
